...
$(document).ready(function () {
    ...
    cambio();
    //---------------- “Match Game” alterna colores )---------
    //-------------------------------------------------------

    $('.col-1').droppable({
        accept: ".col-2"//accept controla en que columna es aceptado el elemento
    });
    $('.col-2').droppable({
        accept: ".col-1, .col-3"
    });
    ...
    function iniciarJuego() {
        ...
        $('#timer').countdowntimer({
            minutes: 2,
            seconds: 0,
            timeUp: function () { //Modifica la interfaz cuando el tiempo termina
                continuar = false;
    ...
    function droppableDraggable() {
        $(".elemento").draggable({ //draggable permite mover elementos
            disabled: false,
